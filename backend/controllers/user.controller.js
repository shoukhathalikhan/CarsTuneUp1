...
exports.updateProfile = async (req, res) => {
  try {
    const { name, phone, address, area, vehicle, isProfileSetupComplete } = req.body;
    ...
    if (isProfileSetupComplete !== undefined) {
      updateData.isProfileSetupComplete = isProfileSetupComplete;
    }
